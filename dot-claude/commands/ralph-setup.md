...
4. `PROMPT_plan_work.md` — loop-scripts.md의 PROMPT_plan_work.md 템플릿 그대로 복사 (plan-work 모드용, ${WORK_SCOPE} 변수는 그대로 유지)
5. `AGENTS.md` — 현재 프로젝트 기술스택(specs/overview.md 참고)에 맞는 빌드/테스트/lint 명령어로 채워서. 60줄 이내.
